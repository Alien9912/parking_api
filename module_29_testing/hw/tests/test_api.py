...
def test_enter_parking(client, db):
    # Создаём нового клиента и новую парковку, чтобы не было конфликта уникальности
...
def test_exit_parking(client, db):
    ...
    # Небольшая задержка, чтобы время выезда гарантированно стало больше времени въезда
    time.sleep(0.01)
